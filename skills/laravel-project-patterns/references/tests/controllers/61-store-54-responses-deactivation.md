...
POST deactivation: Mocked action delegation with generic redirect/toast, exact collection redirect, or deeper existing-record binding; no persistence assertion.

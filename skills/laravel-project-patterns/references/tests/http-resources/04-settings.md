# HTTP Resource Tests: Settings Resource

Exact resource JSON for model settings: enum backing values, integers, true feature flags, a nationally formatted phone, timezone, slug, Sqid and timestamps.

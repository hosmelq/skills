# Requests: Create Optional Settings

Require the initial name, country and timezone. Optional settings use sometimes plus required; false remains a valid boolean. Nullable contact fields and prefix can be cleared.

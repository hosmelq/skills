# HTTP Resources: Stored State Fields

Expose the base enum, sort order and independent initial/visibility flags. This shape has no derived final-state field.

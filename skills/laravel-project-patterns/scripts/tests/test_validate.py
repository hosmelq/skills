...
class CatalogValidationTests(unittest.TestCase):
    ...
    def test_broken_links_escaping_paths_and_unreachable_references_are_reported(self):
        self.write(
            "SKILL.md",
        ...
        self.assertTrue(any("Unreachable Markdown: references/orphan.md" in error for error in errors))

...
description: "Apply the catalog's Laravel controller tests for create, destroy and edit through selective local retrieval when project guidance or the task calls for these patterns."
---

# Laravel Project Patterns

Covers Pest HTTP GET `create`/`edit` and DELETE `destroy` tests, including
...
[destroy](references/tests/controllers/12-destroy-test-order.md) or [edit](references/tests/controllers/22-edit-test-order.md).

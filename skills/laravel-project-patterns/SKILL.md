...
description: "Use the catalog’s Pest test patterns for Laravel controllers, models, HTTP Resources, enums, actions, jobs and media listeners."
---
...
[job checklist](references/tests/jobs/00-job-test-order.md).

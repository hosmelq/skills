...
description: "Use Laravel model, enum, action, FormRequest, controller and HTTP Resource implementation examples and Pest test patterns for controllers, models, HTTP Resources, enums, actions, jobs, middleware, helpers, console commands, architecture and listeners."
---
...
[controller guide](references/controllers/00-controller-implementation-order.md) or
[resource guide](references/http-resources/00-resource-implementation-order.md). For a

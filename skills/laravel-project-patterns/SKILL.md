...
description: "Use Laravel model, enum, action, FormRequest and controller implementation examples and Pest test patterns for controllers, models, HTTP Resources, enums, actions, jobs, middleware, helpers, console commands, architecture and listeners."
---
...
[request guide](references/requests/00-request-implementation-order.md) or
[controller guide](references/controllers/00-controller-implementation-order.md). For a
